...
contract MoodMonkeyNft is ERC721 {
    ...
    constructor(string memory happyMonkeySvgImageUri, string memory sadMonkeySvgImageUri)
    ...
    function _buildTokenMetadata(string memory imageURI) internal view returns (string memory) {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string.concat(_baseURI(), Base64.encode(bytes(_buildTokenMetadata(imageURI))));
    }
}
