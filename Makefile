...
deployMood:
	@forge script script/DeployMoodMonkeyNft.s.sol:DeployMoodMonkeyNft $(NETWORK_ARGS)

mintMoodNft:
	@forge script script/Interactions.s.sol:MintMoodMonkeyNft $(NETWORK_ARGS)

# TODO: add a flag to specify the nftIndex
flipMoodNft:
